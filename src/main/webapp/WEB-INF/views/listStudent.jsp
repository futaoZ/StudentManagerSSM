    ...
    <table class="table table-striped table-bordered table-hover table-condensed">
        ...
        <c:forEach items="${students}" var="s" varStatus="status">
            <tr>
                ...
                <td><a href="${pageContext.request.contextPath }/editStudent?id=${s.id}"><span class="glyphicon glyphicon-edit"></span> </a></td>
                <td><a href="${pageContext.request.contextPath }/deleteStudent?id=${s.id}" onclick="javascript:return del();"> <span class="glyphicon glyphicon-trash"></span> </a></td>
            </tr>
        </c:forEach>
